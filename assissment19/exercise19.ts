...
let guestName :string[]=["Mirza","Abdullah Ali", "Irtiza Ali"];
...
let invitedGuests :string[]=["irtiza","fuzail","mirza"];
 ...
 let newinvitedGuests :string[]=["irtiza","fuzail","mirza"];
...
let updatedguestlist :string[]=["umer","irtiza","fuzail","asheer","anas"]
   updatedguestlist.shift 
    console.log("number og guest invited 5;",updatedguestlist)
